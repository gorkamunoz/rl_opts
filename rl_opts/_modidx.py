...
d = { 'settings': { 'branch': 'master',
                ...
                'lib_path': 'rl_opts'},
  'syms': { 'rl_opts.analytics': { 'rl_opts.analytics.get_policy': ('lib_nbs/analytics.html#get_policy', 'rl_opts/analytics.py'),
                                   'rl_opts.analytics.get_policy_from_dist': ( 'lib_nbs/analytics.html#get_policy_from_dist',
            ...
            'rl_opts.imitation': { 'rl_opts.imitation.PS_imitation': ( 'lib_nbs/imitation_learning.html#ps_imitation',
                                   ...
                                   'rl_opts.imitation.PS_imitation.update': ( 'lib_nbs/imitation_learning.html#ps_imitation.update',
                                                                              'rl_opts/imitation.py')},
            'rl_opts.learn_and_bench': { 'rl_opts.learn_and_bench.agent_efficiency': ( 'lib_nbs/learning.html#agent_efficiency',
                                                                                       'rl_opts/learn_and_bench.py'),
                                         'rl_opts.learn_and_bench.average_search_efficiency': ( 'lib_nbs/learning.html#average_search_efficiency',
                                                                                                'rl_opts/learn_and_bench.py'),
                                         'rl_opts.learn_and_bench.learning': ( 'lib_nbs/learning.html#learning',
                                                                               'rl_opts/learn_and_bench.py'),
                                         'rl_opts.learn_and_bench.walk_from_policy': ( 'lib_nbs/learning.html#walk_from_policy',
                                                                                       'rl_opts/learn_and_bench.py')},
            ...
            'rl_opts.rl_framework': { 'rl_opts.rl_framework.Forager': ('lib_nbs/rl_framework.html#forager', 'rl_opts/rl_framework.py'),
                                      ...
                                      'rl_opts.rl_framework.TargetEnv.update_pos': ( 'lib_nbs/rl_framework.html#targetenv.update_pos',
                                                                                     'rl_opts/rl_framework.py')},
            'rl_opts.run_learning': {'rl_opts.run_learning.get_args': ('py_runs/run_learning.html#get_args', 'rl_opts/run_learning.py')},
            'rl_opts.run_statistics_postlearning': { 'rl_opts.run_statistics_postlearning.get_args': ( 'py_runs/run_statistics_postlearning.html#get_args',
                                                                                                       'rl_opts/run_statistics_postlearning.py')},
