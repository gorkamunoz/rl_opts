...
# %% ../nbs/lib_nbs/develop/launch_robots.ipynb #cf43a7f5-31a1-4b2f-9e14-5918b8e08ca6
import numba
import numpy as np
...
# %% ../nbs/lib_nbs/develop/launch_robots.ipynb #94812bb9-a193-45e1-8134-6c14cc3b0ef5
# Training spec
TIME_EP = 2000
EPISODES = 1000
...
# %% ../nbs/lib_nbs/develop/launch_robots.ipynb #d4ceeafb-2903-4119-acdd-39468170ef26
import numba
import numpy as np
from .robot_search import parallel_robots_trajectories

# %% ../nbs/lib_nbs/develop/launch_robots.ipynb #30287d7d-6dde-4d95-91fe-1f860acaed75
# Training spec
TIME_EP = 1000000
EPISODES = 1
N_AGENTS = 100
