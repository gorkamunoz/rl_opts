# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/lib_nbs/imitation_learning.ipynb.

# %% auto 0
__all__ = ['PS_imitation']

# %% ../nbs/lib_nbs/imitation_learning.ipynb 2
import numpy as np

# %% ../nbs/lib_nbs/imitation_learning.ipynb 4
class PS_imitation():
    def __init__(self, 
