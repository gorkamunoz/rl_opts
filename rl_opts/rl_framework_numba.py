...
# %% ../nbs/lib_nbs/dev_rl_framework_numba.ipynb 87
@njit
...
# %% ../nbs/lib_nbs/dev_rl_framework_numba.ipynb 93
@njit
...
# %% ../nbs/lib_nbs/dev_rl_framework_numba.ipynb 99
...
# %% ../nbs/lib_nbs/dev_rl_framework_numba.ipynb 102
@jitclass([("num_percepts_list", int64[:]),           
           ("initial_prob_distr", float64[:,:]),           
           ("fixed_policy", float64[:,:]) ,
           ("h_matrix", float64[:,:]) ,
...
# %% ../nbs/lib_nbs/dev_rl_framework_numba.ipynb 106
@jitclass([("num_percepts_list", int64[:]),           
           ("initial_prob_distr", float64[:,:]),           
           ("fixed_policy", float64[:,:]) ,
           ("h_matrix", float64[:,:]) ,
...
# %% ../nbs/lib_nbs/dev_rl_framework_numba.ipynb 112
...
# %% ../nbs/lib_nbs/dev_rl_framework_numba.ipynb 122
@jitclass([("size_state_space", int64[:]),           
           ("initial_prob_distr", float64[:,:]),           
           ("fixed_policy", float64[:,:]) ,
           ("h_matrix", float64[:,:]) ,
...
# %% ../nbs/lib_nbs/dev_rl_framework_numba.ipynb 136
@njit(parallel = True)
...
# %% ../nbs/lib_nbs/dev_rl_framework_numba.ipynb 148
@njit
...
# %% ../nbs/lib_nbs/dev_rl_framework_numba.ipynb 168
@njit(parallel = True)
...
# %% ../nbs/lib_nbs/dev_rl_framework_numba.ipynb 174
@njit(parallel = True)
...
# %% ../nbs/lib_nbs/dev_rl_framework_numba.ipynb 185
@njit(parallel = True)
...
# %% ../nbs/lib_nbs/dev_rl_framework_numba.ipynb 190
@njit(parallel = True)
...
# %% ../nbs/lib_nbs/dev_rl_framework_numba.ipynb 198
@njit(parallel = True)
...
# %% ../nbs/lib_nbs/dev_rl_framework_numba.ipynb 206
@njit(parallel = True)
