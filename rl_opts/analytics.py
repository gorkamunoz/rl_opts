# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/lib_nbs/analytics.ipynb.

# %% auto 0
__all__ = ['pdf_multimode', 'pdf_powerlaw', 'pdf_discrete_sample', 'get_policy']

# %% ../nbs/lib_nbs/analytics.ipynb 2
import numpy as np

# %% ../nbs/lib_nbs/analytics.ipynb 5
...
# %% ../nbs/lib_nbs/analytics.ipynb 12
from scipy.special import zeta
