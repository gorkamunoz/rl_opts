...
# %% auto 0
__all__ = ['pdf_multimode', 'pdf_powerlaw', 'pdf_discrete_sample', 'get_policy_from_dist', 'get_policy']
...
# %% ../nbs/lib_nbs/03_analytics.ipynb 13
from scipy.special import zeta
...
def get_policy(n_max, # Maximum counter n_max for which the policy is calculated
    ...
    prob_L = func(L = np.arange(1, n_max+1), **args_func)
