...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #235ce743
import numpy as np
import numba
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #da5241c2
@njit
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #5407c376
@njit
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #b3bd5bc0
@njit
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #c52dc3cc
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #8354d5e7
@njit
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #2758e4cd
@njit(parallel = True)
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #8a449456
@jitclass
class ResetEnv_1D():
    L : float
    D : float    
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #4d3fa165
@njit
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #925598c2
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #634f586c
@njit(parallel = True)
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #0c16f341
@njit(parallel = True)
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #5d689fdd
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #7fa772b4
@jitclass
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #3f3e8a88
@njit
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #3c273c26
@jitclass([("position", float64[:]),
           ("target_position", float64[:,:]),
           ("previous_pos", float64[:])
          ])
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #baee3b3a
@jitclass([("target_positions", float64[:,:]),
           ("position", float64[:]),
           ("previous_pos", float64[:]),
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #46a324ef
@jitclass([("target_positions", float64[:,:]) ,
           ("current_rewards", float64[:]) ,
           ("kicked", float64[:]) ,
           ("current_directions", float64[:]) ,
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #94d9bd91
@njit
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #c7ff59a2
@njit
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #ca9b3118
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #b6d2616b
@jitclass([("num_percepts_list", int64[:]),           
           ("initial_prob_distr", float64[:,:]),           
           ("fixed_policy", float64[:,:]) ,
           ("h_matrix", float64[:,:]) ,
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #b43a514f
@jitclass([("num_percepts_list", int64[:]),           
           ("initial_prob_distr", float64[:,:]),           
           ("fixed_policy", float64[:,:]) ,
           ("h_matrix", float64[:,:]) ,
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #69f98ecd
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #c6f09077
@jitclass([("size_state_space", int64[:]),           
           ("initial_prob_distr", float64[:,:]),           
           ("fixed_policy", float64[:,:]) ,
           ("h_matrix", float64[:,:]) ,
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #145d72a4
@njit
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #7d3c96ce
@njit
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #c858dad1
@njit
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #293ff9e4
@njit(parallel = True)
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #1c49c6e6
@njit
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #46bf4d36
@njit(parallel = True)
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #808a83b6
@njit(parallel = True)
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #8b1aa8b6
@njit(parallel = True)
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #b769de09
@njit(parallel = True)
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #b9a1cc50
@njit(parallel = True)
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #8ce55151
@njit(parallel = True)
...
# %% ../../nbs/lib_nbs/dev_rl_framework_numba.ipynb #6217e7f7
@njit(parallel = True)
