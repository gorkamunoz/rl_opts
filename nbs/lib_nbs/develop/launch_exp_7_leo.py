...
out_dir = "/scratch/c7051165/github/rl_opts/nbs/lib_nbs/develop/results/exp_7"
    ...
    for tau_reward in taus_reward:
        for visual_range in visual_ranges:
            for shared_depletion in [True, False]:
                ...
                print(f"Finished case: tau={tau}, tau_reward={tau_reward}, visual_range={visual_range}, shared_depletion={shared_depletion}")
