...
Nt = 100; 
L = 100 # New larger environment, smaller density
r = 0.5
agent_step = 1
# Time delays

tau = 11 # To promote non-local strategies
taus_reward = [1,2]

# Visual cone
visual_activated = True
visual_range = 2.0
visual_angles = np.pi / np.arange(2,8,2) # Note that this is from the center, so from +45 to -45
